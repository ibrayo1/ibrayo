  ...
  render() {
    return (
      <div>
        ...
        <About />
        <Divider d="M 0 75 L 1005 0 L 0 0 Z" fill="#ECE9E6" bgcolor="transparent" />
        <Portfolio />
        <Divider d="M 0 0 L 335 40 L 380 75 L 625 75 L 670 40 L 1005 0 L 1005 75 L 0 75 Z" fill="#fff" bgcolor="transparent" />
        <Contact />
        <Footer />
      </div>
    );
